...
15) find lorem -iname "*.txt"

16) cat lorem/sed.txt | wc -l

17) find . -name "lorem*" | wc -l

18) grep -i "et" lorem/at.txt

19) grep -i "et" lorem/at.txt | wc -l

20) grep -i -r "et" lorem-copy/ | wc -l
